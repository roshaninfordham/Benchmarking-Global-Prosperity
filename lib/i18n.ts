...
export const dict = {
  en: {
    ...
    mapNote: "India's boundary is drawn as India depicts it (Natural Earth, India point of view). Boundaries and names shown do not imply endorsement or acceptance by the United Nations.",
    keyIndicators: "Key indicators", comparatorAnalysis: "Comparator analysis", addCompHint: "Add a comparator to see how this country compares.", dataFrom: "Data from",
  ...
  fr: {
    ...
    mapNote: "La frontière de l’Inde est tracée comme l’Inde la représente (Natural Earth, point de vue de l’Inde). Les frontières et noms indiqués n’impliquent ni reconnaissance ni acceptation de la part de l’Organisation des Nations Unies.",
    keyIndicators: "Indicateurs clés", comparatorAnalysis: "Analyse comparative", addCompHint: "Ajoutez un comparateur pour situer ce pays.", dataFrom: "Données :",
    findings: { rel: { times: "{x}× {cmp}", diff: "{d} {dir} {cmp}" },
  ...
  es: {
    ...
    mapNote: "La frontera de la India se dibuja como la India la representa (Natural Earth, punto de vista de la India). Las fronteras y los nombres que figuran no implican su aprobación o aceptación por las Naciones Unidas.",
    keyIndicators: "Indicadores clave", comparatorAnalysis: "Análisis comparativo", addCompHint: "Añada un comparador para ver cómo se sitúa este país.", dataFrom: "Datos de",
    findings: { rel: { times: "{x}× {cmp}", diff: "{d} {dir} {cmp}" },
  ...
  ru: {
    ...
    mapNote: "Граница Индии показана так, как её изображает Индия (Natural Earth, точка зрения Индии). Показанные границы и названия не означают их одобрения или признания Организацией Объединённых Наций.",
    keyIndicators: "Ключевые показатели", comparatorAnalysis: "Сравнительный анализ", addCompHint: "Добавьте страну сравнения, чтобы увидеть положение этой страны.", dataFrom: "Данные:",
    findings: { rel: { times: "{x}× {cmp}", diff: "{d} {dir} {cmp}" },
  ...
  zh: {
    ...
    mapNote: "印度边界按印度的标示绘制（Natural Earth，印度视角）。所示边界和名称并不意味着联合国的认可或接受。",
    keyIndicators: "关键指标", comparatorAnalysis: "对比分析", addCompHint: "添加对比对象，查看该国的对比情况。", dataFrom: "数据来源：",
  ...
  ar: {
    ...
    mapNote: "تُرسم حدود الهند كما تصوّرها الهند (Natural Earth، منظور الهند). لا تعني الحدود والأسماء الظاهرة تأييدًا أو قبولًا من الأمم المتحدة.",
    keyIndicators: "المؤشرات الرئيسية", comparatorAnalysis: "تحليل المقارنة", addCompHint: "أضف مقارنة لمعرفة موقع هذا البلد.", dataFrom: "البيانات من",
    findings: { rel: { times: "{x}× {cmp}", diff: "{d} {dir} {cmp}" },
