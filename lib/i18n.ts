...
export const dict = {
  en: {
    ...
    mapNote: "Boundaries and names shown do not imply endorsement or acceptance by the United Nations.",
  ...
  fr: {
    ...
    mapNote: "Les frontières et noms indiqués n’impliquent ni reconnaissance ni acceptation de la part de l’Organisation des Nations Unies.",
  ...
  es: {
    ...
    mapNote: "Las fronteras y los nombres que figuran no implican su aprobación o aceptación por las Naciones Unidas.",
  ...
  ru: {
    ...
    mapNote: "Показанные границы и названия не означают их одобрения или признания Организацией Объединённых Наций.",
  ...
  ar: {
    ...
    mapNote: "لا تعني الحدود والأسماء الظاهرة تأييدًا أو قبولًا من الأمم المتحدة.",
