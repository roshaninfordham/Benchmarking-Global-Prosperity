...
export const dict = {
  ...
  es: {
    ...
    verifyTitle: "Verificar cada valor", graphValue: "En esta vista", officialNow: "Base de datos ODS actual", agency: "Organismo informante", natureCol: "Naturaleza del dato", release: "Versión", snapshotCheck: "Control de la instantánea", identicalWord: "idénticas", sdgApi: "Abrir valor (API ODS)", undpPage: "Abrir datos del país (PNUD)", officialTitle: "Indicador oficial", officialTarget: "Meta oficial", showMembers: "Ver valores de los miembros", newerAvail: "Hay un valor más reciente", notInSource: "No figura en la base de origen", agencies: "Organismos informantes", uncertainty: "Intervalo de incertidumbre", verifyPage: "Cómo se verifican los valores", checkedObs: "observaciones comprobadas",
    findings: { rel: { times: "{x}× {cmp}", diff: "{d} {dir} {cmp}" },
  ...
  zh: {
    ...
    verifyTitle: "核对每个数值", graphValue: "本视图中", officialNow: "当前可持续发展目标数据库", agency: "报告机构", natureCol: "数据性质", release: "版本", snapshotCheck: "快照核对", identicalWord: "一致", sdgApi: "打开数值（SDG API）", undpPage: "打开国家数据（开发署）", officialTitle: "官方指标", officialTarget: "官方具体目标", showMembers: "显示成员数值", newerAvail: "有更新的数值", notInSource: "源数据库中没有", agencies: "报告机构", uncertainty: "不确定性区间", verifyPage: "数值如何核对", checkedObs: "条观测值已核对",
